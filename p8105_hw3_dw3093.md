...
<img src="p8105_hw3_dw3093_files/figure-gfm/unnamed-chunk-12-1.png" width="90%" />
The graph shows 24-hour activity patterns for men and women across
different education levels. Across all groups, there is a sharp increase
in activity in the morning (around 6-9), peaking between 9 AM and 12 PM,
followed by a gradual decline in the afternoon and a smaller peak in the
early evening (around 15-18). Activity levels significantly drop off
after 21 and remain low during nighttime hours. Females consistently
show higher average activity levels compared to males throughout the
day, especially during the peak activity periods. While the overall
patterns are similar across education levels, individuals with less than
a high school education tend to have slightly lower activity levels, and
those with higher education exhibit more sustained and pronounced
morning peaks. In conclusion: the trends suggest that both gender and
education influence daily activity patterns, with females generally
being more active and higher education associated with slightly higher
and longer-lasting activity peaks during the day.
